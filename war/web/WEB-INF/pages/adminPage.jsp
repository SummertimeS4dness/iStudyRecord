...
<div class="panel">
    <table>
        <tr>
            <td>Full name</td>
            <td><input type="text" id="subjectNameCreate"></td>
        </tr>
        <tr>
            <td>Short name</td>
            <td><input type="text" id="subjectSortNameCreate"></td>
        </tr>
        <tr>
            <td>Info</td>
            <td><input type="text" id="subjectInfoCreate"></td>
        </tr>
        <tr>
            <td>Lecturer</td>
            <td><select id="lecturersForSubjectCreate"></select></td>
        </tr>
        <tr>
            <td>
...
<div class="panel">
    <table>
        <tr>
            <td>Description</td>
            <td><input type="text" id="objectDescriptionCreate"></td>
        </tr>
        <tr>
            <td>Type</td>
            <td><select id="objectTypeCreate">
        ...
        <tr>
            <td>
                <button onclick="selectParent()">Choose parent</button>
            </td>
            <td>
                <button onclick="cancelSelectParent()">Back</button>
            </td>
        </tr>
        <tr>
            <td>Parent</td>
            <td><select id="parentTypeCreate" disabled/></td>
        </tr>
        <tr style="visibility: hidden" id="selectCoursTR">
            <td>Cours</td>
            <td><select id="coursSelect">
                <option value=" cours(1)">1</option>
                <option value=" cours(2)">2</option>
                <option value=" cours(3)">3</option>
                <option value=" cours(4)">4</option>
...
<div class="panel">
    <table>
        ...
        <tr>
            <td>
                <button id="showLessons" onclick="lessons()">Show lessons</button>
            </td>
        </tr>
    </table>
    ...
    <table id="onDateEditTable" style="visibility: hidden">
        ...
        <tr>
            <td>
                <button onclick="savaDateChange()">Save</button>
            </td>
        </tr>
    </table>
</div>
...
<div class="panel">
    <table id="lessonAdd">
        ...
        <tr>
            <td>
                <button id="lecturerSelectOnLesson" onclick="addLessonSelectLecturer()">Select lecturer</button>
            </td>
            <td>
                <button onclick="addLessonStart()">Back</button>
            </td>
        </tr>
        <tr>
            <td>Lecturer</td>
        ...
        <tr>
            ...
            <td>
                <button id="saveLesson" onclick="addLessonSave()">Save</button>
            </td>
        </tr>
